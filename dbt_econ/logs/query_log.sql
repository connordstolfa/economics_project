-- created_at: 2026-03-25T22:50:01.045188447+00:00
-- finished_at: 2026-03-25T22:50:01.065397738+00:00
-- elapsed: 20ms
-- outcome: success
-- dialect: duckdb
...
DESCRIBE "economics"."main"."stg_fred_date_based_data";
-- created_at: 2026-03-25T22:50:01.043458616+00:00
-- finished_at: 2026-03-25T22:50:01.065422578+00:00
-- elapsed: 21ms
-- outcome: success
-- dialect: duckdb
-- node_id: not available
-- query_id: not available
-- desc: Get table schema
DESCRIBE "economics"."main"."int_date_spine_month";
-- created_at: 2026-03-25T22:50:01.741805368+00:00
-- finished_at: 2026-03-25T22:50:01.823789461+00:00
-- elapsed: 81ms
-- outcome: success
-- dialect: duckdb
-- node_id: not available
...
select
    spine.date_month as date
        ...
        -- , unemployment_rate_cte.value as unemployment_rate_value
        ...
        -- , consumer_price_index_cte.value as consumer_price_index_value
        ...
        -- , core_consumer_price_index_cte.value as core_consumer_price_index_value
        ...
        -- , personal_consumption_expenditures_index_cte.value as personal_consumption_expenditures_index_value
        ...
        -- , real_gdp_cte.value as real_gdp_value
        ...
        -- , real_gdp_per_capita_cte.value as real_gdp_per_capita_value
        ...
        -- , real_income_per_capita_cte.value as real_income_per_capita_value
        ...
        -- , real_median_household_income_cte.value as real_median_household_income_value
        ...
        -- , recession_indicators_cte.value as recession_indicators_value
